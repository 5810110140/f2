 ...
 *  drawingโ€”methods that draw geometric shapes and methods that
 ...
 *  You save your image to a file using the <em>File โ’ Save</em> menu option.
 ...
 *  call a drawing
 *  methodโ€”such as {@code point()} or {@code line()}โ€”the
 ...
 *       from (0.5, โ€“10^308) to (0.5, 10^308) may not be visible even in the
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * (<em>x</em><sub>1</sub>, <em>y</em><sub>1</sub>), ...,
     * (<em>x</em><sub><em>n</em>โ€“1</sub>, <em>y</em><sub><em>n</em>โ€“1</sub>).
     *
